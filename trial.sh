...
/home/patienza/oscars/LR_annotation/sqanti_evidence -c configs/trial.yaml -j 1 -s -se "--default-resources slurm_account=gge" -R -e "--rerun-triggers input params code --max-jobs-per-second 5 --max-status-checks-per-second 5"
